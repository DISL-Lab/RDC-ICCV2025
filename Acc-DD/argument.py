...
parser.add_argument('--depth', default=18,type=int, help='depth of the network')
...
parser.add_argument('--confidency', type=float, default=0.95)
parser.add_argument('--lambda_unlabeled', type=float, default=25)
...
parser.add_argument('--lambda_val',
                    type=float,
                    default=0.75,
                    help='mixup lambda value for supcon')
## Matching objective
...
parser.add_argument('--model_path', nargs='+', type=str, help='path of pretrained early-stage models')
